const PrivacyPolicy = () => {
  return (
    <div className="max-w-7xl mx-auto p-6 text-gray-900 pt-20">
      <>
        <p>
        ...
        <p>
          <strong>Website</strong> refers to www.pkstone.com, accessible from{" "}
          <a href="http://pkstones.com/">http://pkstones.com/</a>
        </p>
        <p>
