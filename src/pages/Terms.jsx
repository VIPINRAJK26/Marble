    ...
    <div className="container max-w-7xl mx-auto p-6 text-gray-800 pt-20">
      <>
        ...
        <p>
          ...
          "Us" or "Our" in this Agreement) refers to PK STONE, 10/416, NH Road –
          Chumgam Feroke – Kozhikkode Kerala – India PIN: 673631.
        </p>
        <p>
        ...
        <p>
          <strong>Website</strong> refers to www.pkstones.com, accessible from{" "}
          <a href="www.pkstones.com">www.pkstones.com</a>
        </p>
        <p>
        ...
        <p>By email: pkstonecalicut@gmail.com</p>
      </>
    </div>
  );
};
